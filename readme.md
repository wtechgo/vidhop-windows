...
VidHop for Windows also exists. Sync functionality is built-in on both Windows and Android versions of VidHop though that 
...
1. Open Termux and paste this command.
    ...
    ```   
       curl -sL https://raw.githubusercontent.com/wtechgo/vidhop-windows/master/install.sh > install.sh && 
...
VidHop enables Windows users to download videos, songs, thumbnails, complete channels and playlists from popular video
